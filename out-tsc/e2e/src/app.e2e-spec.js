...
describe('workspace-project App', function () {
    ...
    it('buttons from mobile should not exist, button from high width page should exist, and should return correct text', function () {
    ...
    it('should mobile buttons exist, and return correct text', function () {
    ...
    it('click on best-rated button(on high width) should redirect to best-rated component, Footer should still display' +
        'click on till title should redirect to serie detail', function () {
        page.navigateToFullWidth();
    ...
    it('click on search button(on high width) should redirect to search component. Footer should still display', function () {
        page.navigateToFullWidth();
        browser.get('/test');
    ...
    it('click on button(on small screen) should redirect to chosen component, Footer should still display', function () {
        page.navigateToMobile();
        page.getMobileMenuBtn().click();
    ...
    it('click on lastWeek table row should redirect to serieDetail component', function () {
        page.navigateToFullWidth();
        page.getLastWeekTrendsFirstEl().click();
        expect(element(by.id('serieDetail')).isPresent()).toEqual(true);
        expect(element(by.id('footer')).isPresent()).toEqual(true);
    });
    it('click on slide shoult change viev', function () {
        page.navigateToFullWidth();
        page.getBestRatedBtn().click();
