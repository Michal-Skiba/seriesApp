...
import { FakeShowSeriesDetalService } from '../../../tests/test-services/fakeShowSeriesDetalService.service';
import { FakeSeriesService } from '../../../tests/test-services/fakeSeriesService.service';
...
describe('SeriesSearchComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: ShowSeriesDetailService, useClass: FakeShowSeriesDetalService },
